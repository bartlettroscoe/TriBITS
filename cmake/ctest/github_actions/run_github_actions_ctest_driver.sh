...
#
# This will create the subdir 'tribits-build' under the $PWD if that directory
# does not already exist.  It will not delete an existing directly if it
# already exists.
#
...
# tribits_ctest_driver() documentation including not submitting to CDash.
#
